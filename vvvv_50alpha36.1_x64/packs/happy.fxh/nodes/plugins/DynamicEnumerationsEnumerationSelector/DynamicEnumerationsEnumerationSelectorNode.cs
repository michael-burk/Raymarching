...
{
	#region PluginInfo
	[PluginInfo(Name = "EnumerationSelector", Category = "Enumerations", Version = "Dynamic", Help = "Basic template with dynamic custom enumeration", Tags = "c#")]
	#endregion PluginInfo
	public class DynamicEnumerationsEnumerationSelectorNode : IPluginEvaluate
	{
		#region fields & pins
		...
		public DynamicEnumerationsEnumerationSelectorNode()
		{
			var s = new string[] {
				"one",
				"two"
			...
			EnumManager.UpdateEnum(id.ToString(), "two", s);
		}
